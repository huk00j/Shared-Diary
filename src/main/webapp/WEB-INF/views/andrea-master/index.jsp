		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight">
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<c:if test="${sessionScope.loging == null}">
			...
			<div class="colorlib-footer">
				<h1 id="colorlib-logo" class="mb-4">
					<a href="index.html"
						style="background-image: url(resources/images/bg_1.jpg);">Andrea
						<span>Moore</span>
					</a>
				</h1>
				<div class="mb-4">
					...
					<c:choose>
						<c:when test="${sessionScope.loging == null}">
							<form action="loginConfirm" class="colorlib-subscribe-form"
								...
								<div class="form-group d-flex">
									...
									<input type="text" class="form-control"
										placeholder="Enter Email Address" name="loginID">
								</div>

								<div class="form-group d-flex">
									<input type="text" class="form-control"
										placeholder="Enter Password" name="loginPW">
								</div>
								<%--
						 ...
						 --%>
								<div class="btn-custom">
									<input type=hidden name="login"> <a
										href="javascript:document.loginForm.submit();"> Login <span
						...
						<c:otherwise>
							<c:if test="${sessionScope.loging != null}">
								<form action="logoutConfirm" class="colorlib-subscribe-form"
									method="post" name="myForm">
									<a>${sessionScope.loging} 님 환영합니다.</a><br>
									<div class="btn-custom">
										<%--
										<input type="submit" value="Logout"
											class="btn btn-primary py-3 px-5">
						 		--%>
										<input type=hidden name="logout"> <a
											href="javascript:document.myForm.submit();"> Logout <span
						...
						<div class="col-xl-8 py-5 px-md-5">
							<div class="row pt-md-4">
								...
								<div class="col-md-12">
									<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.html" class="img img-2"
											style="background-image: url(resources/images/image_7.jpg);"></a>
										<div class="text text-2 pl-md-4">
											<h3 class="mb-2">
												<a href="single.html">You Can't Blame Gravity for
													Falling in Love</a>
								...
								<div class="col-md-12">
									<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.html" class="img img-2"
											style="background-image: url(resources/images/image_8.jpg);"></a>
										<div class="text text-2 pl-md-4">
											<h3 class="mb-2">
												<a href="single.html">You Can't Blame Gravity for
													Falling in Love</a>
								...
								<div class="col-md-12">
									<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.html" class="img img-2"
											style="background-image: url(resources/images/image_9.jpg);"></a>
										<div class="text text-2 pl-md-4">
											<h3 class="mb-2">
												<a href="single.html">You Can't Blame Gravity for
													Falling in Love</a>
								...
								<div class="col-md-12">
									<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.html" class="img img-2"
											style="background-image: url(resources/images/image_10.jpg);"></a>
										<div class="text text-2 pl-md-4">
											<h3 class="mb-2">
												<a href="single.html">You Can't Blame Gravity for
													Falling in Love</a>
								...
								<div class="col-md-12">
									<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.html" class="img img-2"
											style="background-image: url(resources/images/image_11.jpg);"></a>
										<div class="text text-2 pl-md-4">
											<h3 class="mb-2">
												<a href="single.html">You Can't Blame Gravity for
													Falling in Love</a>
								...
								<div class="col-md-12">
									<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.html" class="img img-2"
											style="background-image: url(resources/images/image_12.jpg);"></a>
										<div class="text text-2 pl-md-4">
											<h3 class="mb-2">
												<a href="single.html">You Can't Blame Gravity for
													Falling in Love</a>
